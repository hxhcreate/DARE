...
case "${task}" in
  ...
  mmlupro)
    ...
    ;;
  hellaswag)
    py_script=sdar_examples/${prefix}sdar_1dot7b_chat_gen_hellaswag_length3.py
    work_dir=outputs/${prefix}sdar_1dot7b_chat_gen_hellaswag_length3
    ;;
  arcc)
  ...
  gpqa)
    ...
    ;;
  humaneval)
    py_script=sdar_examples/${prefix}sdar_1dot7b_chat_gen_humaneval_length768.py
    work_dir=outputs/${prefix}sdar_1dot7b_chat_gen_humaneval_length768
    ;;
  mbpp)
    py_script=sdar_examples/${prefix}sdar_1dot7b_chat_gen_mbpp_length1024.py
    work_dir=outputs/${prefix}sdar_1dot7b_chat_gen_mbpp_length1024
    ;;
  gsm8k)
