                ...
                for data in micro_batches:
                    ...
                    for i in range(mc_num):
                        ...
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = compute_policy_loss(
                            ...
                            response_mask=mask_indices[:, i, :][:, -response_length:],  # (bsz, response_length)
                        ...
                        if self.config.use_kl_loss:  # NOTE: Currently not considering KL
                            ...
                            # compute kl loss
                            kld = kl_penalty(l_theta=log_prob[:, 0, :], ref_l_theta=ref_log_probs[:, i, :], kl_penalty=self.config.kl_loss_type, advantages=advantages)
